      ...
      <main style={{ flexGrow: 1, background: "var(--cream)" }}>
        ...
        <div style={{
          ...
          <div className="wrap" style={{ position: "relative", zIndex: 2 }}>
            <span className="eyebrow light" style={{ justifyContent: "center", color: "var(--amber)" }}>KWS Sports Wing Event</span>
            <h1 style={{ fontFamily: "var(--serif)", fontSize: "clamp(3rem, 5vw, 4.5rem)", color: "#fff", margin: "16px 0", lineHeight: 1.1 }}>
              KWS Super League 2026
            </h1>
        ...
        <div style={{ background: "var(--amber)", color: "var(--ink)", padding: "40px 0", marginTop: "-30px", position: "relative", zIndex: 10 }} className="stats-strip">
          <div className="wrap stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "30px", textAlign: "center" }}>
            <div>
              <div style={{ fontSize: "2.5rem", fontWeight: "bold", lineHeight: 1 }}>Format</div>
              <div style={{ fontWeight: 600, textTransform: "uppercase", letterSpacing: 1, marginTop: 5, fontSize: "0.9rem" }}>Tape Ball T10</div>
            </div>
            <div>
              <div style={{ fontSize: "2.5rem", fontWeight: "bold", lineHeight: 1 }}>Teams</div>
              <div style={{ fontWeight: 600, textTransform: "uppercase", letterSpacing: 1, marginTop: 5, fontSize: "0.9rem" }}>12 Local Clubs</div>
            </div>
            <div>
              <div style={{ fontSize: "2.5rem", fontWeight: "bold", lineHeight: 1 }}>Venue</div>
              <div style={{ fontWeight: 600, textTransform: "uppercase", letterSpacing: 1, marginTop: 5, fontSize: "0.9rem" }}>Khurram Ground</div>
            </div>
          </div>
        </div>
        ...
        <section style={{ padding: "100px 0", background: "#fff" }}>
          <div className="wrap" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }}>
            <div>
              ...
              <h2 style={{ fontSize: "2.5rem", marginBottom: "20px", lineHeight: 1.2 }}>Promoting competitive cricket in <em style={{ color: "var(--green)" }}>our community.</em></h2>
            ...
            <div style={{ position: "relative" }}>
              <div style={{ background: "var(--cream)", borderRadius: "24px", overflow: "hidden", aspectRatio: "4/3", boxShadow: "var(--shadow-soft)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                {/* Placeholder for actual image */}
                <span style={{color: "var(--muted)"}}>Event Photo Coming Soon</span>
              </div>
            </div>
          </div>
        </section>
