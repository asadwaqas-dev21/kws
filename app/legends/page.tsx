...
const legends: Legend[] = [
  ...
  {
    name: "نواز سلطان رحمانی",
    image: "/legends/Nawaz Sultan Rehmani.jpeg",
    role: "ہر دلعزیز نوجوان",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "رحمانی",
    bio: [
      "نواز سلطان رحمانی خرم ہٹھاڑ کے ایک انتہائی خوش اخلاق، ہنس مکھ اور خوش مزاج نوجوان تھے۔ ان کی رونقی شخصیت اور چہرے پر ہمہ وقت مسکراہٹ محفل کی جان ہوا کرتی تھی۔",
      "ان کا دوستانہ رویہ اور ملنساری انہیں ہر عمر کے لوگوں میں بے حد مقبول بناتی تھی۔ ان کی جواں سالی، نیک دلی اور مسکراہٹ کی یادیں گاؤں والوں کے دلوں میں ہمیشہ زندہ رہیں گی۔",
    ],
  },
  {
  ...
  },
  {
    ...
    image: "/legends/Baba g Allah Ditta.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
  ...
  },
  {
    ...
    image: "/legends/Baba g Bashir Ahmad.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
  ...
  {
    name: "بابا جی علی محمد",
    image: "/legends/Baba g Ali Muhammad.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی علی محمد اپنی نیک نیتی، درگزر اور گاؤں کے لوگوں سے محبت کے لئے جانے جاتے تھے۔ ان کی سادگی اور اخلاص نے انہیں سب کا عزیز بنا دیا۔",
      "خرم ہٹھاڑ کی تاریخ میں ان کا نام اور کردار ہمیشہ ایک محترم بزرگ کے طور پر یاد رکھا جائے گا۔",
    ],
  },
  {
    name: "بابا جی حافظ خوشی محمد",
    image: "/legends/Baba g Hafiz Khushi Muhammad.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی حافظ خوشی محمد اپنی دیانت، بردباری اور لوگوں سے محبت کی وجہ سے خرم ہٹھاڑ میں عزت کی نگاہ سے دیکھے جاتے تھے۔ انہوں نے ہمیشہ امن اور بھائی چارے کو ترجیح دی۔",
      "ان کی سادہ زندگی اور نیک اعمال آج بھی نوجوان نسل کے لیے سبق ہیں۔ ان کا نام گاؤں کی یادگار شخصیات میں محفوظ ہے۔",
    ],
  },
  {
    name: "بابا جی حاجی عبدالرزاق",
    image: "/legends/Baba g Haji Abdul Razzaq.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی حاجی عبدالرزاق ایک متقی اور نیک انسان تھے جنہوں نے دینی اور دنیاوی معاملات میں توازن قائم رکھا۔ ان کی زندگی خدمت اور اخلاص کی مثال تھی۔",
      "خرم ہٹھاڑ میں ان کی عزت اور محبت آج بھی قائم ہے۔ ان کی یاد کمیونٹی کے لیے باعثِ افتخار ہے۔",
    ],
  },
  {
    name: "بابا جی حاجی محمد ادریس",
    image: "/legends/Baba g Haji Muhammad Idrees.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی حاجی محمد ادریس اپنی خاموش خدمت، صبر اور نیک نیتی کے لیے مشہور تھے۔ انہوں نے ہمیشہ لوگوں کے درمیان صلح اور محبت کو فروغ دیا۔",
      "ان کی نیک یادیں گاؤں والوں کے دلوں میں محفوظ ہیں۔ وہ ہمیشہ ایک محترم اور عزیز شخصیت کے طور پر یاد رہیں گے۔",
    ],
  },
  {
    name: "بابا جی حاجی محمد اسحاق",
    image: "/legends/Baba g Haji Muhammad Ishaq.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی حاجی محمد اسحاق اپنی خوش اخلاقی، رواداری اور کمیونٹی سے گہرے لگاؤ کے لیے جانے جاتے تھے۔ انہوں نے زندگی بھر لوگوں کے درمیان محبت اور اتحاد کو فروغ دیا۔",
      "خرم ہٹھاڑ میں ان کی یاد آج بھی تازہ ہے۔ ان کا کردار کمیونٹی کے لیے رہنمائی کا باعث ہے۔",
    ],
  },
  {
    name: "بابا جی محمد رمضان",
    image: "/legends/Baba g Muhammad Ramzan.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی محمد رمضان ایک نیک اور پرخلوص شخصیت تھے جنہوں نے اپنی زندگی خدمت، محنت اور ایمانداری سے بسر کی۔ گاؤں کے لوگ ان کی شفقت اور رہنمائی کو ہمیشہ یاد رکھتے ہیں۔",
      "ان کا کردار خرم ہٹھاڑ کی سماجی زندگی میں روشنی کا سبب رہا۔ ان کی یاد آج بھی کمیونٹی کے دلوں میں زندہ ہے۔",
    ],
  },
  {
    name: "بابا جی محمد شریف",
    image: "/legends/Baba g Muhammad Sharif.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی محمد شریف اپنی سادگی، دیانت اور کمیونٹی سے محبت کی وجہ سے یاد کیے جاتے ہیں۔ انہوں نے ہمیشہ دوسروں کی مدد کو اپنی خوشی سمجھا۔",
      "ان کی نیک یادیں خرم ہٹھاڑ کی اجتماعی زندگی کا قیمتی سرمایہ ہیں۔ وہ ایک عزیز اور محترم شخصیت کے طور پر زندہ رہیں گے۔",
    ],
  },
  {
    name: "بابا جی محمد یوسف",
    image: "/legends/Baba g Muhammad Yousaf.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی محمد یوسف ایک باعمل اور پرخلوص انسان تھے جنہوں نے گاؤں کی بہتری اور لوگوں کے مسائل حل کرنے میں اہم کردار ادا کیا۔ ان کی شخصیت میں عزم اور ہمدردی نمایاں تھی۔",
      "ان کی خدمات خرم ہٹھاڑ کے لیے باعثِ فخر ہیں۔ ان کا ورثہ آنے والی نسلوں کے لیے سبق ہے۔",
    ],
  },
  {
    name: "بابا جی ٹھیکیدار محمد حسین",
    image: "/legends/Baba g Thekedar Muhammad Hussain.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی ٹھیکیدار محمد حسین اپنی ذمہ داری، حوصلہ مندی اور کمیونٹی کے معاملات میں بھرپور کردار کے لیے مشہور تھے۔ وہ ہمیشہ گاؤں کی بہتری اور لوگوں کے مسائل حل کرنے میں پیش پیش رہتے۔",
      "ان کی محنت اور وفاداری نے انہیں خرم ہٹھاڑ کی قابلِ فخر شخصیات میں شامل کر دیا۔ ان کا ورثہ آنے والے وقتوں کے لیے مشعلِ راہ ہے۔",
    ],
  },
  {
    name: "محمد انور اسحاق",
    image: "/legends/Muahammad Anwar Ishaq.jpeg",
    role: "سماجی شخصیت",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "محمد انور اسحاق اپنی ہمت، جذبۂ خدمت اور کمیونٹی سے وابستگی کے لیے جانے جاتے ہیں۔ انہوں نے معاشرے کے لیے مثبت سوچ اور عمل کی مثال قائم کی۔",
      "ان کی کاوشیں خرم ہٹھاڑ کی ترقی اور بہتری میں مددگار ثابت ہوئی ہیں۔ وہ کمیونٹی کے لیے ایک روشن نام ہیں۔",
    ],
  },
  {
    name: "بابا جی نذیر احمد غلام محمد",
    image: "/legends/Baba g Nazir Ahmad Gulam Muhammad.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی نذیر احمد غلام محمد اپنی نیک نیتی، درگزر اور گاؤں کے لوگوں سے محبت کے لئے جانے جاتے تھے۔ ان کی سادگی اور اخلاص نے انہیں سب کا عزیز بنا دیا۔",
      "خرم ہٹھاڑ کی تاریخ میں ان کا نام اور کردار ہمیشہ ایک محترم بزرگ کے طور پر یاد رکھا جائے گا۔",
    ],
  },
  {
    name: "بابا جی عنایت",
    image: "/legends/Baba g Anayat.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی عنایت اپنی خاموش خدمت، صبر اور نیک نیتی کے لیے مشہور تھے۔ انہوں نے ہمیشہ لوگوں کے درمیان صلح اور محبت کو فروغ دیا۔",
      "ان کی نیک یادیں گاؤں والوں کے دلوں میں محفوظ ہیں۔ وہ ہمیشہ ایک محترم اور عزیز شخصیت کے طور پر یاد رہیں گے۔",
    ],
  },
  {
    name: "بابا جی صدیق احمد",
    image: "/legends/Baba g Siddique Ahmad.jpeg",
    role: "بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "کمبوہ",
    bio: [
      "بابا جی صدیق احمد ایک نیک اور پرخلوص شخصیت تھے جنہوں نے اپنی زندگی خدمت، محنت اور ایمانداری سے بسر کی۔ گاؤں کے لوگ ان کی شفقت اور رہنمائی کو ہمیشہ یاد رکھتے ہیں۔",
      "ان کا کردار خرم ہٹھاڑ کی سماجی زندگی میں روشنی کا سبب رہا۔ ان کی یاد آج بھی کمیونٹی کے دلوں میں زندہ ہے۔",
    ],
  },
];
