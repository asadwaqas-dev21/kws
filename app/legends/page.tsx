...
const legends: Legend[] = [
  {
    ...
    role: "سماجی رہنما و بزرگانِ قوم",
    village: "خرم ہٹھاڑ",
    lifespan: "یادگار شخصیت",
    cast: "رحمانی",
    bio: [
      "نواز سلطان رحمانی خرم ہٹھاڑ کی ایک ایسی بااثر شخصیت تھے جنہوں نے ہمیشہ سماجی فلاح اور لوگوں کی بھلائی کے لیے کام کیا۔",
      "ان کی بے لوث خدمات اور نیک اعمال آج بھی گاؤں والوں کے دلوں میں زندہ ہیں۔ ان کا کردار کمیونٹی کے لیے ہمیشہ مشعلِ راہ رہے گا۔",
    ],
  },
  {
