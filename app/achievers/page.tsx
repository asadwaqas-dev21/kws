...
export default function AchieversPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <main className="legends-page" dir="ltr" lang="en">
        <div className="legends-hero reveal in" style={{
          background: "linear-gradient(rgba(15, 23, 42, 0.75), rgba(15, 23, 42, 0.9)), url('/Achievers-hero-bg.png') center/cover no-repeat",
          color: "white",
          padding: "100px 0"
        }}>
          <div className="wrap center" style={{ position: "relative", zIndex: 2 }}>
            <span className="eyebrow" style={{ justifyContent: "center", color: "var(--amber)", textShadow: "0 2px 4px rgba(0,0,0,0.8)" }}>Our Heroes</span>
            <h1 className="h-sec" style={{ color: "#ffffff", textShadow: "0 2px 8px rgba(0,0,0,0.8)", marginTop: "10px", fontFamily: "inherit", fontWeight: "normal" }}>Achievers of <em style={{ color: "var(--amber)", fontStyle: "normal" }}>Khurram Hithar.</em></h1>
            <p className="lead" style={{ color: "rgba(255,255,255,0.95)", textShadow: "0 2px 6px rgba(0,0,0,0.8)", maxWidth: "700px", margin: "0 auto" }}>Celebrating the success, dedication, and leadership of the bright minds from our community.</p>
          </div>
        </div>

        <div className="legend-showcase">
          <div className="wrap legends-list">
            {Achievers.map((legend) => (
              <div className="legend-split reveal in" key={legend.image}>
                ...
                <div className="ls-right">
                  ...
                  <div className="ls-meta" style={{ textAlign: "left", direction: "ltr" }}>
                    ...
                    <div className="lsm-item">
                      <span className="lsm-label">Caste</span>
                      <span className="lsm-val">{legend.cast}</span>
                    </div>
                  </div>

                  <div className="ls-bio" style={{ textAlign: "left" }}>
                    <h3 className="ls-bio-title">Biography</h3>
