        ...
        <div className="wrap">
          ...
          <div className="team-grid">
            <div className="tm reveal in">
              <div className="tm-img"><img src="/Muhammad Saleem Ahmad.jpg" alt="Muhammad Saleem Ahmad" loading="lazy" referrerPolicy="no-referrer" onError={(e) => { e.currentTarget.style.display = 'none'; }} /></div>
      ...
      <footer>
        <div className="wrap">
          <div className="foot-top">
            ...
            <div className="foot-col"><div style={{fontSize: "1.1rem", fontWeight: "bold", marginBottom: "15px", color: "#fff"}}>Our Work</div><a href="#focus">Clean Water</a><a href="#focus">Education</a><a href="#focus">Health</a><a href="#focus">Welfare</a><a href="#focus">Blood Donation</a></div>
            <div className="foot-col"><div style={{fontSize: "1.1rem", fontWeight: "bold", marginBottom: "15px", color: "#fff"}}>Get Involved</div><a href="#causes">Donate</a><a href="#contact">Volunteer</a><a href="#contact">Membership</a><a href="#team">Our Team</a></div>
            <div className="foot-col"><div style={{fontSize: "1.1rem", fontWeight: "bold", marginBottom: "15px", color: "#fff"}}>Contact</div><a href="#">Khurram, Kasur, Pakistan</a><a href="tel:+923334178699">+92 333 4178 699</a><a href="mailto:kwsociety2014@gmail.com">kwsociety2014@gmail.com</a></div>
          </div>
